...
class FillPermissionsForCuttingArea extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCuttingArea constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cutting-area',
            'admin.cutting-area.index',
            'admin.cutting-area.create',
            'admin.cutting-area.show',
            'admin.cutting-area.edit',
            'admin.cutting-area.delete',
            'admin.cutting-area.bulk-delete',
        ]);
