...
class FillPermissionsForWoodSpecie extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForWoodSpecie constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.wood-specie',
            'admin.wood-specie.index',
            'admin.wood-specie.create',
            'admin.wood-specie.show',
            'admin.wood-specie.edit',
            'admin.wood-specie.delete',
            'admin.wood-specie.bulk-delete',
        ]);
