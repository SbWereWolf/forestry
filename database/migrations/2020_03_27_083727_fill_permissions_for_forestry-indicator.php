...
class FillPermissionsForForestryIndicator extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForForestryIndicator constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.forestry-indicator',
            'admin.forestry-indicator.index',
            'admin.forestry-indicator.create',
            'admin.forestry-indicator.show',
            'admin.forestry-indicator.edit',
            'admin.forestry-indicator.delete',
            'admin.forestry-indicator.bulk-delete',
        ]);
