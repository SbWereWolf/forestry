...
class FillPermissionsForForestResource extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForForestResource constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.forest-resource',
            'admin.forest-resource.index',
            'admin.forest-resource.create',
            'admin.forest-resource.show',
            'admin.forest-resource.edit',
            'admin.forest-resource.delete',
            'admin.forest-resource.bulk-delete',
        ]);
